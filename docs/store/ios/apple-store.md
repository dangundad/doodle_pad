# Doodle Pad App Store 등록정보 (정본)

이 문서는 Doodle Pad iOS App Store 등록정보의 **정본(Source of Truth)**입니다.
`./store.sh ios from-docs` (또는 `./store.sh ios push`) 명령어를 실행하면 이 문서를 자동으로 파싱하여 fastlane deliver metadata를 생성하고 App Store Connect에 반영합니다.
...
#### 부제 (30자 이내)
Draw, save, and reopen doodles

#### 프로모션 텍스트 (170자 이내)
Draw, save, and reopen doodles with 10 brushes and colors.

#### 키워드 (100자 이내)
app,digital,aesthetic,minimal,tool,utility,clean,station,portrait,landscape,dark
...
#### 부제 (30자 이내)
10종 브러시로 그리고, 저장하고, 다시 열어 이어 그

#### 프로모션 텍스트 (170자 이내)
10종 브러시로 그리고, 저장하고, 다시 열어 이어 그리세요.

#### 키워드 (100자 이내)
앱,디지털,감성,미니멀,유틸리티,도구,인테리어,가로모드,심플,다크모드
...
#### 키워드 (100자 이내)
アプリ,デジタル,ミニマル,便利,ツール,時計,置き時計,シンプル,ダークモード
...
#### 부제 (30자 이내)
Mit 10 Pinseln zeichnen, speic

#### 프로모션 텍스트 (170자 이내)
Mit 10 Pinseln zeichnen, speichern und später fortsetzen.

#### 키워드 (100자 이내)
app,digital,minimalistisch,werkzeug,nutzen,design,station,querformat,dunkel
...
#### 부제 (30자 이내)
Dessinez, enregistrez et repre

#### 프로모션 텍스트 (170자 이내)
Dessinez, enregistrez et reprenez avec 10 pinceaux.

#### 키워드 (100자 이내)
application,digitale,minimaliste,outil,utilitaire,design,paysage,sombre
...
#### 부제 (30자 이내)
Dibuja, guarda y retoma con 10

#### 프로모션 텍스트 (170자 이내)
Dibuja, guarda y retoma con 10 pinceles y colores.

#### 키워드 (100자 이내)
aplicacion,digital,minimalista,herramienta,utilidad,estilo,horizontal,oscuro
...
#### 부제 (30자 이내)
Desenhe, salve e retome com 10

#### 프로모션 텍스트 (170자 이내)
Desenhe, salve e retome com 10 pincéis e cores.

#### 키워드 (100자 이내)
aplicativo,digital,minimalista,ferramenta,utilidade,design,horizontal,escuro
...
#### 부제 (30자 이내)
10 кистей: рисуйте, сохраняйте

#### 프로모션 텍스트 (170자 이내)
10 кистей: рисуйте, сохраняйте и продолжайте позже.

#### 키워드 (100자 이내)
приложение,цифровой,минимализм,инструмент,утилита,стиль,темная,удобный
...
#### 부제 (30자 이내)
Gambar, simpan, dan lanjutkan

#### 프로모션 텍스트 (170자 이내)
Gambar, simpan, dan lanjutkan dengan 10 kuas.

#### 키워드 (100자 이내)
aplikasi,digital,minimalis,alat,utilitas,desain,layar,gelap,praktis
...
#### 부제 (30자 이내)
ارسم واحفظ وتابع لاحقًا مع 10

#### 프로모션 텍스트 (170자 이내)
ارسم واحفظ وتابع لاحقًا مع 10 فرش.

#### 키워드 (100자 이내)
تطبيق,رقمي,بسيط,أداة,خدمي,جميل,شاشة,أفقي,داكن,عملي
